...
# 2. Write the Dash app code into app/app.py
dash_app_code = """
import dash
...
try:
    # Notice we look one directory up because the terminal runs from the app folder, 
    # but the notebook saved the model in the root.
...
app.layout = html.Div(style={'fontFamily': 'Arial, sans-serif', 'maxWidth': '800px', 'margin': '0 auto', 'padding': '20px'}, children=[
    html.H1("Do you AGREE? (NLI Predictor)", style={'textAlign': 'center', 'color': '#2c3e50'}),
...
# Write a requirements.txt suitable for Dash
with open("app/requirements.txt", "w") as f:
    f.write("torch\\ntransformers\\ndash\\n")

print("Successfully created app/app.py (Dash version)")
print("To run the web app, open your terminal, navigate to the notebook's directory, and run:")
